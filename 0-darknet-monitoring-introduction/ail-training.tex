...
\begin{frame}
        \frametitle{Concepts - tor\footnote{licence: Bits of Freedom CC BY-SA 3.0}}
        \begin{itemize}
...
\begin{frame}
        \frametitle{Concepts - tor\footnote{licence: Harrison Neal CC BY-SA 3.0}}
	\includegraphics[scale=0.3]{images/tor2.png}
\end{frame}

\begin{frame}
        \frametitle{Concepts - tor\footnote{licence: Roger Dingledine, Nick Mathewson, Paul Syverson CC BY 3.0}}
