...
\begin{frame}
        \frametitle{Analysing contents - Investigations}
        \begin{itemize}
		\item Building a collection of {\bf labelled} objects
        	\begin{itemize}
        	\item fully compatible with MISP events, taxonomies and galaxies,
        	\item regroup proccessed objects for further analysis,
			\item keep track of analyzed objects,
			\item analysts collaboration,
        	\end{itemize}
        	
		\item Export and share via MISP.
        \end{itemize}
\end{frame}
