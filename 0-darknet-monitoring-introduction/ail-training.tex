...
\begin{frame}
        \frametitle{Concepts - search engines}
        \begin{itemize}
		\item Building a search engine on the web is a challenging task because:
        	\begin{itemize}
			\item it has to crawl webpages,
			\item it has to to make sense of unstructured data,
			\item it has to index these data,
			\item it has to provide a way to retrieve data.
        	\end{itemize}
