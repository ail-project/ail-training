...
rule WEBSHELL_CVE_2021_27065_Webshells {
   ...
   condition:
      any of ($script*) and ($externalurl or $internalurl) and $internalauthenticationmethods and $extendedprotectiontokenchecking
}
...
rule WEBSHELL_Compiled_Webshell_Mar2021_1 {
   ...
   condition:
      all of ($x*) and 1 of ($a*) and ( all of ($b*) or all of ($c*) )
}
