...
\begin{itemize}
    \item Over the past seven years, we have developed the AIL project\footnote{\url{https://www.ail-project.org/}} to fulfill our needs at CIRCL in intelligence gathering and analysis.
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Bloom Filter Filtering - Privaye Search Set (PSS)
        \item Relationships between Chats: message forwards, replies, etc.
    \end{itemize}
\end{frame}
